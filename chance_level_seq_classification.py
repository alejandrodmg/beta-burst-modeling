...
if __name__ == "__main__":
    ...
    rand_class_models_scores = {}
    sims_per_fold = 200 # Number of simulations/shuffles per fold

    for rat_session in tqdm(rat_groups):
        rat_id = get_rat_id(rat_session[0])
        rand_class_models_scores[rat_id] = {}
        ...
        for model_group, model_list in models.items():
            ...
            for model in model_list:
                ...
                rand_class_models_scores[rat_id][model_group][model_id] = []
                for seed in seeds:
                    ...
                    # Here starts the simulation for chance-level results
                    for sim in range(sims_per_fold):
